...
!function (e, define) {
    ...
    return function (e, t, n) {
        ...
        function o(i, o, c, d, m, v) {
            function _() {
                var n, v, _, w, y, x, C, S, T, M, P, z, F;
                return c.kRebind && (n = e(e(o)[0].cloneNode(!0))), v = d.replace(/^kendo/, ""), _ = t.extend({}, c.defaultOptions, i.$eval(c.kOptions || c.options)), (w = e(o)[d]) ? (y = w.widget.prototype.options, x = w.widget.prototype.events, e.each(c, function (e, t) {
                    var n, o, a, s;
                    ...
                    }), x.indexOf(o) > -1 && (_[o] = t)), y.hasOwnProperty(n) ? r(i, _, n, t) : y.hasOwnProperty(e) && !I[e] ? r(i, _, e, t) : E[e] || (a = e.match(/^k(On)?([A-Z].*)/), a && (s = a[2].charAt(0).toLowerCase() + a[2].slice(1), a[1] && "kOnLabel" != e ? _[s] = t : ("kOnLabel" == e && (s = "onLabel"), r(i, _, s, t)))))
                }), C = c.kDataSource || c.source, C && (_.dataSource = A(i, o, v, C)), _.$angular = [i], o.is("select") && !function (t) {
                    if (t.length > 0) {
                        var n = e(t[0]);
                        !/\S/.test(n.text()) && /^\?/.test(n.val()) && n.remove()
                    }
                }(o[0].options), S = w.call(o, D = _).data(d), l(S, i, c, d, m), i.$emit("kendoWidgetCreated", S), T = p(i, S), c.kRebind && g(S, i, o, n, c.kRebind, T, c), c.kNgDisabled && (M = c.kNgDisabled, P = i.$eval(M), P && S.enable(!P), a(S, i, o, M)), c.kNgReadonly && (z = c.kNgReadonly, F = i.$eval(z), F && S.readonly(F), s(S, i, o, z)), c.kNgModel && h(S, i, c.kNgModel), b && u(S, i, o, b, k), S && f(S, o), S) : (window.console.error("Could not find: " + d), null)
            }
            ...
            return w = c.kNgDelay, y = i.$eval(w), v = v || [], b = v[0], k = v[1], w && !y ? (x = i.$root || i, S = function () {
        ...
        function u(e, t, i, r, o) {
            ...
            }, e.first("change", l(!1)), e.first("dataBound", l(!0)), u = a(), u != r.$viewValue && (r.$isEmpty(r.$viewValue) ? null != u && "" !== u && u != r.$viewValue && r.$setViewValue(u) : e.value(r.$viewValue)), r.$setPristine())
        }

        function h(t, i, r) {
            var o, a, s, l, c;
            return "function" != typeof t.value ? (T.warn("k-ng-model specified on a widget that does not have the value() method: " + t.options.name), n) : (o = e(t.element).parents("form"), a = i[o.attr("name")], s = x(r), l = s.assign, c = !1, t.$angular_setLogicValue(s(i)), i.$apply(function () {
                var e = function (e, i) {
                    e === n && (e = null), c || e !== i && t.$angular_setLogicValue(e)
                };
                kendo.ui.MultiSelect && t instanceof kendo.ui.MultiSelect ? i.$watchCollection(r, e) : i.$watch(r, e)
            }), t.first("change", function () {
        ...
        function g(t, n, i, r, o, a, s) {
            var l = n.$watch(o, function (o, c) {
                var d, u, h, p;
                o !== c && (l(), d = B[t.options.name], d && d.forEach(function (t) {
                    var i = n.$eval(s["k" + t]);
                    i && r.append(e(i).attr(kendo.toHyphens("k" + t), ""))
                }), u = e(t.wrapper)[0], h = e(t.element)[0], p = i.injector().get("$compile"), t.destroy(), a && a(), t = null, u && h && (u.parentNode.replaceChild(h, u), e(i).replaceWith(r)), p(r)(n))
            }, !0);
            _(n)
        }
        ...
        function m(e, n) {
            ...
            l += e.fn.options.name, r = l, o = "kendo" + l.charAt(0) + l.substr(1).toLowerCase(), l = "kendo" + l, a = l.replace(/([A-Z])/g, "-$1"), -1 == z.indexOf(l.replace("kendo", "")) && (s = l === o ? [l] : [l, o], t.forEach(s, function (e) {
                b.directive(e, function () {
                    return {
                        restrict: "E", replace: !0, template: function (e, t) {
                            var n = P[r] || "div", i = t.kScopeField;
        ...
        function _(e, t) {
            var n = e.$root || e, i = /^\$(digest|apply)$/.test(n.$$phase);
        ...
        var b, k, x, C, S, T, D, A, E, I, M, P, z, F, R, B;
        t && (b = t.module("kendo.directives", []), k = t.injector(["ng"]), x = k.get("$parse"), C = k.get("$timeout"), T = k.get("$log"), A = function () {
            var e = {
            ...
            return function (n, i, r, o) {
                var a = e[r] || "DataSource", s = t(n.$eval(o), a);
                return n.$watch(o, function (e, n) {
                    var r, o;
                    e !== n && (r = t(e, a), o = v(i), o && "function" == typeof o.setDataSource && o.setDataSource(r))
                }), s
            }
        }(), E = {kDataSource: !0, kOptions: !0, kRebind: !0, kNgModel: !0, kNgDelay: !0}, I = {
            name: !0,
            title: !0,
            style: !0
        }, M = /^(input|select|textarea)$/i, b.factory("directiveFactory", ["$compile", function (t) {
            var n, i = 0, r = !1;
            return S = t, n = function (t, n) {
                return {
                    ...
                    link: function (a, s, l, c) {
                        var d = e(s), u = t.replace(/([A-Z])/g, "-$1"), h = "hidden" !== d.css("visibility");
            ...
            F.push(e), e = "kendo" + e, b.directive(e, function () {
                return {
        ...
        }(), R = [], y(kendo.ui, "plugin", function (t, n, i) {
            this.next(), R = e.grep(R, function (e) {
                return !y.apply(null, e)
            }), m(t, "Mobile" == i)
        }), y(["ui.Widget", "mobile.ui.Widget"], "angular", function (r, o) {
            var a, s = this.self;
            return "init" == r ? (!o && D && (o = D), D = null, o && o.$angular && (s.$angular_scope = o.$angular[0], s.$angular_init(s.element, o)), n) : (a = s.$angular_scope, a && i(function () {
                var i, l, c = o(), d = c.elements, u = c.data;
        ...
        }), y("ui.Widget", "$angular_getLogicValue", function () {
            return this.self.value()
        }), y("ui.Widget", "$angular_setLogicValue", function (e) {
            this.self.value(e)
        }), y("ui.Select", "$angular_getLogicValue", function () {
            var e = this.self.dataItem();
            return e ? this.self.options.valuePrimitive ? e[this.self.options.dataValueField] : e.toJSON() : null
        }), y("ui.Select", "$angular_setLogicValue", function (e) {
            var t = this.self, n = t.options, i = n.dataValueField, r = n.text || "";
            e = e || "", i && !n.valuePrimitive && e && (r = e[n.dataTextField] || "", e = e[i || n.dataTextField]), t.options.autoBind !== !1 || t.listView.isBound() ? t.value(e) : t._preselect(e, r)
        }), y("ui.MultiSelect", "$angular_getLogicValue", function () {
            var t = this.self.dataItems().slice(0), n = this.self.options.dataValueField;
            return n && this.self.options.valuePrimitive && (t = e.map(t, function (e) {
                return e[n]
            })), t
        }), y("ui.MultiSelect", "$angular_setLogicValue", function (t) {
            var n, i, r, o;
        ...
        }), y("ui.AutoComplete", "$angular_getLogicValue", function () {
            var e, t, n, i, r, o = this.self.options, a = this.self.value().split(o.separator), s = o.valuePrimitive, l = this.self.dataSource.data(), c = [];
            for (e = 0, t = l.length; t > e; e++)for (n = l[e], i = o.dataTextField ? n[o.dataTextField] : n, r = 0; a.length > r; r++)if (i === a[r]) {
                c.push(s ? i : n.toJSON());
                break
            }
            return c
        }), y("ui.AutoComplete", "$angular_setLogicValue", function (t) {
            null == t && (t = []);
            var n = this.self, i = n.options.dataTextField;
            i && !n.options.valuePrimitive && (t = e.map(t, function (e) {
                return e[i]
            })), n.value(t)
        }), y("ui.Widget", "$angular_init", function (t, n) {
            var i, r, o, a, s = this.self;
            if (n && !e.isArray(n))for (i = s.$angular_scope, r = s.events.length; --r >= 0;)o = s.events[r], a = n[o], a && "string" == typeof a && (n[o] = s.$angular_makeEventHandler(o, i, a))
        }), y("ui.Widget", "$angular_makeEventHandler", function (e, t, n) {
            return n = x(n), function (e) {
                _(t, function () {
                    n(t, {kendoEvent: e})
                })
            }
        }), y(["ui.Grid", "ui.ListView", "ui.TreeView"], "$angular_makeEventHandler", function (e, n, i) {
            return "change" != e ? this.next() : (i = x(i), function (e) {
                var r, o, a, s, l, c, d, u, h, p = e.sender, f = p.options, g = {kendoEvent: e};
        ...
        }), y("ui.Grid", "$angular_init", function (i, r) {
        ...
        }), y("mobile.ui.ButtonGroup", "value", function (e) {
            var t = this.self;
            ...
            return {
                restrict: "E", replace: !0, template: function (e) {
            ...
            b.directive(t, function () {
                return {
                    restrict: "A", priority: 2, link: function (n, i, r) {
            ...
            var e = {};
            t.forEach(B, function (n, i) {
                t.forEach(n, function (t) {
                    e[t] || (e[t] = []), e[t].push("?^^kendo" + i)
                })
            }), t.forEach(e, function (e, t) {
                var n = "k" + t, i = kendo.toHyphens(n);
                b.directive(n, function () {
                    return {
                        restrict: "A", require: e, terminal: !0, compile: function (t, r) {
                            if ("" === r[n]) {
                                t.removeAttr(i);
                                var o = t[0].outerHTML;
